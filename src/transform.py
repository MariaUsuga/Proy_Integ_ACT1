...
def run_queries(database: Engine) -> Dict[str, DataFrame]:
    ...
    """
    '''
    def get_freight_value_weight_relationship_from_json():
        """Reads freight_value_weight_relationship data from json and returns a pandas DataFrame."""
    with open("tests/expected/get_freight_value_weight_relationship.json", "r") as f:
        data = json.load(f)
